...
jQuery(document).ready(function ($) {
  ...
  if (window.matchMedia("(max-width: 1024px)").matches) {
    ...
    $("#header nav").wrapAll("<menu></menu>"); //Déplace le place btn#close comme premier enfant de <menu></menu>> 

    $("#close").prependTo("#header menu"); //Déplace le place .social-media comme dernier enfant de <menu></menu>> 

    $("#header .social-media").insertAfter("#header menu nav"); // état à l'ouverture du menu
