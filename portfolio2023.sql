...
(8, 'Splash Screen pastèque', 'Splash-screen-pasteque', 1, 'Digital', 'Adobe XD, Illustrator', '2021', 'Splash Screen animé d\'une interface mobile sur le thème de la pastèque.', 'UI & UX', 'NULL', 'https://player.vimeo.com/video/654248995', 'NULL', NULL, NULL),
(9, 'Audio Player', 'Audio-player', 1, 'Digital', ' XD', '2021', 'Dans le cadre d\'un cours d\'UI/UX design, nous devions réaliser un design original de player audio avec la transition animée entre deux musiques.', 'UI & UX', 'Repenser l\'interface d\'un player de musique, en lui donnant un style cybernétique par l\'utilisation du glassmorphism.', 'https://player.vimeo.com/video/654249675', 'NULL', NULL, NULL),
(10, 'Recette de cuisine asiatique', 'Recette-de-cuisine-asiatique', 1, 'Digital', 'Adobe XD', '2021', 'Interface mobile d\'une page de recette d\'une application mobile.', 'UI & UX', 'NULL', 'https://player.vimeo.com/video/657412628', 'NULL', NULL, NULL),
(11, 'Carte interactive', 'Carte-interactive', 1, 'Digital', 'Adobe XD', '2021', 'Découverte des espèces marines à travers une carte interactive.', 'UI & UX', 'NULL', 'https://player.vimeo.com/video/661780846', 'NULL', NULL, NULL),
(12, 'UP\'event', 'Up-event', 1, ' Digital', 'Figma, Indesign, Illustrator', '2021', 'Développer un projet autour des thèmes relations humaines, réseaux et services ainsi que numérisation du monde.', 'Data, Prototypage, Application mobile, UI & UX', 'Up\'event est une application mobile dédiée aux événements et sorties étudiantes dans la ville de Valenciennes. Sous forme ludique, l\'application invite les étudiants à proposer des rencontres et événements ou à participer à ceux de nos partenaires. Sous forme de calendrier et de carte, l\'application invite ses utilisateurs à se rencontrer, à partager leurs intérêts en dehors de leurs études et à marquer des points pour leur maison.', 'https://player.vimeo.com/video/662958130', 'https://www.behance.net/gallery/134945973/UPevent', NULL, NULL),
...
(14, 'Affiches CCI Widmer', 'Affiche-CCI-Widmer', 2, 'Print', 'Illustrator', '2021', 'Dans la lignée de Widmer, ces affiches fictives d’une exposition 2022 au CCI mettent en avant des objets du quotidien.', 'Poster', 'NULL', 'NULL', 'NULL', NULL, NULL),
(15, 'Serres Royales de Laeken', 'Serres-Royales-de-Laeken', 1, 'Print | Digital', 'Illustrator, Indesign, Photoshop', '2021', 'Élaboration de la charte graphique de Laeken, en passant de la création de son logotype à sa déclinaison sur les supports de communication print et digitaux.', 'Identité de marque', 'NULL', 'https://player.vimeo.com/video/662957351', 'https://www.behance.net/gallery/134289793/Serres-Royales-de-Laeken-Charte-Graphique', NULL, NULL);
